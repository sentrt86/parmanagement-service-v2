...
public class ParMasterDAOImpl implements IParMasterDAO{
	...
	public Boolean createParMaster(ParMaster parmaster) {
		...
		Object[] parms = new Object[] {parmaster.getParId(),parmaster.getParNumber(),parmaster.getParDescriptionText(),parmaster.getParReceivedDate(),parmaster.getParStatus(),parmaster.getIntentToFill(),parmaster.getEmailSent(),parmaster.getParComment()};
		int[] parmsType = new int[] {Types.INTEGER,Types.CHAR,Types.CHAR,Types.DATE,Types.CHAR,Types.BOOLEAN,Types.BOOLEAN,Types.CHAR};
	...
	public Boolean createParMasterRltn(ParMaster parmaster) {
		...
		Object[] parms = new Object[] {parmaster.getParNumber(),parmaster.getParRole().getRoleId(),parmaster.getSkill().getSkillId(),parmaster.getArea().getAreaId(),parmaster.getExternalStaff().getExtStaffId(),parmaster.getLocation().getLocationId()};
		int[] parmsType = new int[] {Types.CHAR,Types.INTEGER,Types.INTEGER,Types.INTEGER,Types.INTEGER,Types.INTEGER};
	...
	@Override
	public Boolean updateIntentToFill(String parNum, Boolean intentToFill, String intentSentDate) {
		Boolean parMasterUpdated = false;
		Object[] parms = new Object[] {intentToFill,LocalDate.parse(intentSentDate),parNum};
		int[] parmsType = new int[] {Types.BOOLEAN,Types.DATE,Types.CHAR};
